...
-- === Journal des essais d'extraction de reçu (voir migration
-- 20260916000000_add_receipt_scan_logs.sql pour le détail) ===

create table public.receipt_scan_logs (
  id uuid primary key default gen_random_uuid(),
  -- default auth.uid() : voir le commentaire équivalent dans
  -- supabase/migrations/20260916000000_add_receipt_scan_logs.sql.
